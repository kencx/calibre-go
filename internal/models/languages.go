...
var LanguageWhere = struct {
	...
	ID:       whereHelpernull_Int64{field: "\"languages\".\"id\""},
	LangCode: whereHelperstring{field: "\"languages\".\"lang_code\""},
	Link:     whereHelperstring{field: "\"languages\".\"link\""},
}
...
var (
	languageAllColumns            = []string{"id", "lang_code", "link"}
	languageColumnsWithoutDefault = []string{"lang_code"}
	languageColumnsWithDefault    = []string{"id", "link"}
	languagePrimaryKeyColumns     = []string{"id"}
	languageGeneratedColumns      = []string{"id"}
)
...
func FindLanguageG(ctx context.Context, iD null.Int64, selectCols ...string) (*Language, error) {
	return FindLanguage(ctx, boil.GetContextDB(), iD, selectCols...)
}
...
func (o *Language) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, languageGeneratedColumns)
...
func (o *Language) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"languages\"", updateOnConflict, ret, update, conflict, insert)
...
func LanguageExistsG(ctx context.Context, iD null.Int64) (bool, error) {
	return LanguageExists(ctx, boil.GetContextDB(), iD)
}
