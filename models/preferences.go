...
var PreferenceWhere = struct {
	...
	ID:  whereHelpernull_Int64{field: "\"preferences\".\"id\""},
	Key: whereHelperstring{field: "\"preferences\".\"key\""},
	Val: whereHelperstring{field: "\"preferences\".\"val\""},
}
...
var (
	preferenceAllColumns            = []string{"id", "key", "val"}
	preferenceColumnsWithoutDefault = []string{"key", "val"}
	preferenceColumnsWithDefault    = []string{"id"}
	preferencePrimaryKeyColumns     = []string{"id"}
	preferenceGeneratedColumns      = []string{"id"}
)
...
// OneG returns a single preference record from the query using the global executor.
func (q preferenceQuery) OneG(ctx context.Context) (*Preference, error) {
...
// AllG returns all Preference records from the query using the global executor.
func (q preferenceQuery) AllG(ctx context.Context) (PreferenceSlice, error) {
...
// CountG returns the count of all Preference records in the query using the global executor
func (q preferenceQuery) CountG(ctx context.Context) (int64, error) {
...
func (q preferenceQuery) ExistsG(ctx context.Context) (bool, error) {
...
func FindPreferenceG(ctx context.Context, iD null.Int64, selectCols ...string) (*Preference, error) {
	return FindPreference(ctx, boil.GetContextDB(), iD, selectCols...)
}
...
func FindPreference(ctx context.Context, exec boil.ContextExecutor, iD null.Int64, selectCols ...string) (*Preference, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"preferences\" where \"id\"=?", sel,
	)
...
func (o *Preference) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, preferenceGeneratedColumns)
...
// UpdateG a single Preference record using the global executor.
...
func (q preferenceQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Preference) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"preferences\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Preference) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"preferences\" WHERE \"id\"=?"
...
func (q preferenceQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func PreferenceExistsG(ctx context.Context, iD null.Int64) (bool, error) {
	return PreferenceExists(ctx, boil.GetContextDB(), iD)
}
...
func PreferenceExists(ctx context.Context, exec boil.ContextExecutor, iD null.Int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"preferences\" where \"id\"=? limit 1)"
